            ...
            <div id={uniqueId}>
                {
                    collapseData.map((colItem, colIInd) => {
                        return (
                            <div key={colIInd}>
                                <div className="border-bottom" id={`heading-${colIInd}`}>
                                    <h5 className="collapse_button d-flex align-items-center justify-content-between py-4">
                                        <a
                                            role="button"
